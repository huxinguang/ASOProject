...
@property (nonatomic, strong) YbsCameraController *cameraVC;
...
- (UIImagePickerController *)ipvc {
    if (_ipvc == nil) {
        ...
        _ipvc.navigationBar.barTintColor = self.navigationController.navigationBar.barTintColor;
        _ipvc.navigationBar.tintColor = self.navigationController.navigationBar.tintColor;
...
- (void)configCollectionView {
    ...
    if (_showTakePhotoBtn) {
        ...
        if (_models.count == 0) {
            ...
            _noDataLabel.font = kYbsFontCustomBold(20);
...
- (void)pushImagePickerController {
    ...
    if ([UIImagePickerController isSourceTypeAvailable: sourceType]) {
        self.ipvc.sourceType = sourceType;
        ...
        if (tzImagePickerVc.allowTakeVideo) {
            ...
            self.ipvc.videoMaximumDuration = tzImagePickerVc.videoMaximumDuration;
        }
        self.ipvc.mediaTypes= mediaTypes;
        if (tzImagePickerVc.uiImagePickerControllerSettingBlock) {
            tzImagePickerVc.uiImagePickerControllerSettingBlock(_ipvc);
        }
        [self presentViewController:_ipvc animated:YES completion:nil];
    } else {
