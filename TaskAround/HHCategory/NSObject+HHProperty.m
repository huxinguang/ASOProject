...
@implementation NSObject (HHProperty)
...
+ (void)hh_swizzleMethodSource:(SEL)source destination:(SEL)destination
{
    ...
    Method sourceMethod = class_getInstanceMethod(class, source);
    Method destinationMethod = class_getInstanceMethod(class, destination);
