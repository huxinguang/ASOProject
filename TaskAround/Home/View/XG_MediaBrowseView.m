...
- (void)presentCellImageAtIndexPath:(NSIndexPath *)indexpath
    ...
    YbsSelectedPicCell *assetCell = (YbsSelectedPicCell *)[_fromCollectionView cellForItemAtIndexPath:indexpath];
    _fromView = assetCell.imgView;
...
//    [[NSNotificationCenter defaultCenter]postNotificationName:kShowStatusBarNotification object:nil];
    ...
    if (self.fromItemIndex == currentPage) {
        ...
        YbsSelectedPicCell *assetCell = (YbsSelectedPicCell *)[_fromCollectionView cellForItemAtIndexPath:[NSIndexPath indexPathForItem:currentPage inSection:0]];
        fromView = assetCell.imgView;
    }
