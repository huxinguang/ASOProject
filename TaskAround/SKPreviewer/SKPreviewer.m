...
- (void)previewFromImageView:(UIImageView *)imageView container:(UIView *)container
{
    ...
    self.scrollView.contentSize = CGSizeMake(self.sk_width, MAX(self.containerView.sk_height, self.sk_height));
...
//                保存图片至相册
                ...
                dispatch_async(dispatch_get_main_queue(), ^{
                    [[UIViewController currentViewController] showMessageToWindow:[NSString stringWithFormat:@"%@",success ? @"保存成功":@"保存失败"] hideDelay:1];
